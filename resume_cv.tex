...
\makecvfooter{\today}{Sena Kavukcu~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
\input{cv-sections/expreriences.tex}
